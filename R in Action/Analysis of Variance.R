...
#Using a multiple comparison procedure to tell which one differ from one another
TukeyHSD(fit)
par(las=2)
par(mar=c(5,8,4,2))
plot(TukeyHSD(fit))
...
bartlett.test(response~trt, data=cholesterol)#Variances in the five groups don't differ significantly
