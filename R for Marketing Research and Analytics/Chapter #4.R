...
#Create a number of variables describing the customers
...
#Online sales against indoor sales
...
corrplot.mixed(corr=cor(cust.df[,c(2,3,5:12)], use="complete.obs"),
               upper="ellipse", t1.pos = "1t",col=colorpanel(50, "red","gray60","blue4"))
...
#Typical Marketing Data Transformation
...
#Histogram between transformed and untransformed variables
par(mfrow=c(1,2))
...
plot(cust.df$sat.service, cust.df$sat.selection,
     xlab="Customer Satisfaction with Server",
     ylab="Cusomter Satisfactor with sSElection",
     main="Customers as of June 2014
     ")
#Jitter()
